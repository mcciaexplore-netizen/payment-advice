  ...
  return (
    <main className="mx-auto flex w-full max-w-sm flex-1 flex-col items-center justify-center gap-8 px-6 py-16">
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <h1 className="font-heading text-2xl text-[#0b1f3a]">Team Dashboard</h1>
        <p className="text-sm text-gray-600">Sign in to track your submissions and team activity.</p>
      </div>
